...
### 🏛️ Certum Preset (Pre-configured)

**For Certum Private project, use this preset:**

```bash
python3 .agent/.shared/ui-ux-pro-max/scripts/search.py "wealth luxury private banking white gold minimal serif" --design-system -p "Certum Private"
```

**Certum Design System Override:**

- **Background:** `#FFFFFF` (Absolute White)
- **Primary Accent:** `#C9A227` (Gold)
- **Typography:** Playfair Display (headlines) + Inter (body) + JetBrains Mono (labels)
- **Style:** Brutalismo de Luxo — sharp edges, heavy animations, no bouncy effects
- **Stack:** Vite + React (NOT html-tailwind)

> 📖 **Full rules:** `.agent/rules/certum-overrides.md`
