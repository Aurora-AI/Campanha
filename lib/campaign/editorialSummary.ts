...
function resolveEffectiveCampaignWindow(options: {
  ...
  if (hasAnyWithinConfig) {
    return { campaignStart: configStart, campaignEnd: configEnd, referenceDayFromData: maxWithinConfig };
  }
  ...
  return { campaignStart: configStart, campaignEnd: configEnd, referenceDayFromData: null };
}
